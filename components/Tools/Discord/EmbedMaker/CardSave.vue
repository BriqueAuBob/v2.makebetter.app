...
<template>
    <div
        ...
        :class="
            isSelected
                ? '-translate-y-2 border-primary-500 bg-white shadow-lg shadow-primary-400 dark:bg-zinc-600 dark:shadow-zinc-800'
                : 'border-transparent bg-primary-200 hover:-translate-y-2 hover:bg-white hover:shadow-md hover:shadow-primary-300 dark:bg-zinc-900 dark:hover:bg-primary-600 dark:hover:shadow-primary-800'
        "
    >
        ...
        />
        <div
            class="absolute left-0 top-0 flex h-full w-full flex-col justify-between bg-gradient-to-b from-transparent to-primary-500 p-6 dark:to-zinc-700"
        >
            ...
            <div>
                <div
                    class="absolute bottom-0 left-0 h-24 w-full overflow-hidden rounded-3xl bg-primary-500 opacity-75 blur-xl dark:bg-zinc-700"
                ></div>
