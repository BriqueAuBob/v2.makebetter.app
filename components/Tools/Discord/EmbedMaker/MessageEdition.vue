	...
	<div class="mt-2 flex flex-col gap-8">
		<ToolsCardCollapsible collapse title="Auteur du message" noHover>
			<UIInput
				...
				:placeholder="
					$t('tools.discord.embed.fields.username.placeholder')
				"
			...
			<UIInput
				...
				:placeholder="
					$t('tools.discord.embed.fields.avatar_url.placeholder')
				"
				...
				>
					...
					>
						<UIInput
							...
							:label="
								$t('tools.discord.embed.fields.author.label')
							"
							:placeholder="
								$t(
									'tools.discord.embed.fields.author.placeholder'
								)
							"
						...
						<UIInput
							...
							:label="
								$t(
									'tools.discord.embed.fields.author_icon.label'
								)
							"
							:placeholder="
								$t(
									'tools.discord.embed.fields.author_icon.placeholder'
								)
							"
						...
						<UIInput
							...
							:label="
								$t(
									'tools.discord.embed.fields.author_url.label'
								)
							"
							:placeholder="
								$t(
									'tools.discord.embed.fields.author_url.placeholder'
								)
							"
					...
					>
						<UIInput
							...
							:label="
								$t('tools.discord.embed.fields.title.label')
							"
							:placeholder="
								$t(
									'tools.discord.embed.fields.title.placeholder'
								)
							"
						...
						<UIInput
							...
							:label="
								$t(
									'tools.discord.embed.fields.description.label'
								)
							"
							:placeholder="
								$t(
									'tools.discord.embed.fields.description.placeholder'
								)
							"
						...
						<UIInput
							...
							:placeholder="
								$t('tools.discord.embed.fields.url.placeholder')
							"
						...
						>
							...
							>
								<UIInput
									...
									:label="
										$t(
											'tools.discord.embed.fields.field_name.label'
										)
									"
									:placeholder="
										$t(
											'tools.discord.embed.fields.field_name.placeholder'
										)
									"
									v-model="field.name"
								...
								<UIInput
									...
									:label="
										$t(
											'tools.discord.embed.fields.field_value.label'
										)
									"
									:placeholder="
										$t(
											'tools.discord.embed.fields.field_value.placeholder'
										)
									"
									v-model="field.value"
								...
								<UIInput
									...
									:label="
										$t(
											'tools.discord.embed.fields.field_inline.label'
										)
									"
									:placeholder="
										$t(
											'tools.discord.embed.fields.field_inline.placeholder'
										)
									"
					...
					>
						<UIInput
							...
							:label="
								$t(
									'tools.discord.embed.fields.footer_text.label'
								)
							"
							:placeholder="
								$t(
									'tools.discord.embed.fields.footer_text.placeholder'
								)
							"
						...
						<UIInput
							...
							:label="
								$t(
									'tools.discord.embed.fields.footer_icon.label'
								)
							"
							:placeholder="
								$t(
									'tools.discord.embed.fields.footer_icon.placeholder'
								)
							"
						...
						<UIInput
							...
							:label="
								$t('tools.discord.embed.fields.timestamp.label')
							"
							:placeholder="
								$t(
									'tools.discord.embed.fields.timestamp.placeholder'
								)
							"
		...
		<div class="relative" :class="!webhookCreatedByBot && 'p-12'">
			...
			>
				...
				>
					<ToolsCardCollapsible
						collapse
						v-for="(component, componentId) in message.components[0]
							.components"
						:key="componentId"
						class="border-dashed"
					...
					>
						<UIInput
							...
							:label="
								$t(
									'tools.discord.embed.fields.button_label.label'
								)
							"
							:placeholder="
								$t(
									'tools.discord.embed.fields.button_label.placeholder'
								)
							"
						...
						<UIInput
							...
							:label="
								$t(
									'tools.discord.embed.fields.button_url.label'
								)
							"
							:placeholder="
								$t(
									'tools.discord.embed.fields.button_url.placeholder'
								)
							"
