    ...
    <article class="relative overflow-hidden rounded-3xl border-2 text-center shadow-md">
        ...
        <div class="p-8">
            ...
            >
                ...
                <div
                    class="bouncy-bezier absolute mt-4 w-full cursor-pointer rounded-2xl bg-white p-4 text-left shadow-2xl shadow-pink-500 duration-500 hover:-translate-y-24 dark:bg-zinc-950 xl:top-full"
                    :class="!hasClicked && 'translate-y-96 opacity-0'"
                    @click="handleClick"
                >
                    {{ $t('homepage.features.ai.sentence.improved') }}
                </div>
            </div>
        </div>
    </article>
